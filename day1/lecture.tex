...
\note{
	\begin{itemize}
	\item The author of the PR typically should resolve the conflicts as they are the ones who are proposing to CHANGE something from how it was. They should be able to explain WHY it should be changed to the person maintaining the main branch. 
	\end{itemize}
}
...
\note{
	\begin{itemize}
		\item Let me demonstrate what this looks like before we move to an exercise. 
	\end{itemize}
}
