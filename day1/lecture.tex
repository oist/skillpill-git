...
I want to first focus on the bottom two arrows here. These are the tools we use to save exactly what changed between versions of our project. }
...
\frametitle{Quick Exercise}
    \begin{block}{EXERCISE}
        ...
        \item Take a peak in the newly created .git directory
        \end{enumerate}
    \end{block}
